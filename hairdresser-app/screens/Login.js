		...
		<KeyboardAvoidingView style={styles.kbContainer}>
			<View style={styles.container}>
				<View style={styles.formContainer}>
					<TextInput value={username} style={commonStyles.input} autoCapitalize={"none"} textContentType={"username"} caretHidden={false} placeholder="Username" placeholderTextColor="#A3A9AA" autoComplete={"username"} importantForAutofill={"yes"} onChangeText={text => setUsername(text)}/>
